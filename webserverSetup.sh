...
openssl ca -config intermediate/openssl.cnf -extensions server_cert -days 375 -notext -md sha256 -in intermediate/csr/10.0.17.29.csr.pem -out intermediate/certs/10.0.17.29.cert.pem
